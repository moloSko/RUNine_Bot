...
$discord->listenCommand('отряд', function (Interaction $interaction) use ($discord, $imgotr){
  try{
    ...
    if ($interaction->channel_id == '1069872550210969610'){
      if ($memberd->roles->get('id', '959168899671277658')){
...
$discord->listenCommand('тишина', function (Interaction $interaction) use ($discord){
  ...
  $carbon = new Carbon();
  if ($interaction->member->roles->get('id', '1023596275616194612') or $interaction->member->roles->get('id', '1023596365412044801') or $interaction->member->roles->get('id', '978542340933308456')){
